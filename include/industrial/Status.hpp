/**
 * @file Status.hpp
 * @brief Minimal status code enum and lightweight Status wrapper for reporting operation outcomes.
 * 
 * @note currently unused, keeping in case richer error info is needed later.
 */
